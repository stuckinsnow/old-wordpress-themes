...
<div id="filters">
    <div id="the-add-bug" class="filters"><label class="load-more-button"></label><div class="vislabel">Load More</div></div>
    <div id="shuffle" class="filters"><label></label><div class="vislabel">Shuffle</div></div>
    <div id="remove-all" class="filters"><label></label><div class="vislabel">Clear</div></div>
...
?>
    ...
    <div class="vislabel">Information</div>
    </div>
